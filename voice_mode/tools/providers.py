...
from voice_mode.config import TTS_BASE_URLS, STT_BASE_URLS, STT_MODEL
            ...
            for url in urls:
                if optimistic:
                    ...
                    provider_registry.registry[service][url] = EndpointInfo(
                        base_url=url,
                        models=[STT_MODEL] if service == "stt" else (["tts-1", "tts-1-hd"] if "openai.com" in url else ["tts-1"]),
